...
<body>
    <header>
        <h1>📊 Rapport Mensuel - {{ $mois }} {{ $annee }}</h1>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $etudiant->date_inscription?->format('d/m/Y') }}</td>
            </tr>
            @empty
            <tr>
                <td colspan="7" style="text-align: center; padding: 20px;">Aucune inscription ce mois-ci</td>
            </tr>
            @endforelse
        </tbody>
    </table>
